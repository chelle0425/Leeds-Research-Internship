...
for i in {1..8}; do
    ...
    gmt grdmath $frame1 0 NAN = $frame1=gd:GTiff
    frame2=tosend2/$framekey2.$keystr.geo.tif
    gmt grdmath $frame2 0 NAN = $frame2=gd:GTiff
    ...
    gmt grdmath $M2 0 NAN $M1 0 NAN ADD = $framekey1'_'$framekey2.$keystr.geo.tif=gd:GTiff
    #gmt grdmath $framekey1'_'$framekey2.$keystr.geo.tif 0 NAN = $framekey1'_'$framekey2.$keystr.geo.tif
